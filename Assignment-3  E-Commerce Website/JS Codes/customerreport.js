...
function fetchCustomerReports() {
    fetch('https://firestore.googleapis.com/v1/projects/e-commerce-base2/databases/(default)/documents/Customer')
...
function getTop10Customers() {
    fetch('https://firestore.googleapis.com/v1/projects/e-commerce-base2/databases/(default)/documents/Purchase', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
function fetchCustomerDetails(customerIds, orderCounts) {
    const promises = customerIds.map(customerId => {
        return fetch(`https://firestore.googleapis.com/v1/projects/e-commerce-base2/databases/(default)/documents/Customer/${customerId}`, {
            method: 'GET'
        })
        .then(response => response.json())
        .then(data => {
