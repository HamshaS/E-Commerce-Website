$(document).ready(function() {
  var baseURL = 'https://firestore.googleapis.com/v1/projects/e-commerce-base2/databases/(default)/documents/';
      ...
      success: function(response) {
        ...
        if (categories && categories.length > 0) {
          var categoryExists = categories.some(function(category) {
            if (category && category.fields && category.fields.name && category.fields.name.stringValue) {
