(function() {
    ...
    $(document).ready(function() {
        ...
        function fetchCustomerInfo() {
            ...
            if (customerId) {
                $.ajax({
                    url: `https://firestore.googleapis.com/v1/projects/e-commerce-base2/databases/(default)/documents/Customer/${customerId}`,
                    type: 'GET',
        ...
        $.ajax({
            url: 'https://firestore.googleapis.com/v1/projects/e-commerce-base2/databases/(default)/documents/Inventory',
            type: 'GET',
            success: function(response) {
        ...
        $('#paymentButton').one('click', function() {
            ...
            if (confirmation) {
                ...
                updateInventory();
                createOrder(paymentMethod); // Pass paymentMethod as argument
                    ...
                    inventoryItems.forEach(inventoryItem => {
                        ...
                        if (cartProduct) {
                            ...
                            if (newQuantity >= 0) {
                                ...
                                $.ajax({
                                    url: `https://firestore.googleapis.com/v1/projects/e-commerce-base2/databases/(default)/documents/Inventory/${inventoryId}`,
                                    type: 'PATCH',
        ...
        function createOrder() {
            ...
            if (customerId) {
                ...
                .then(categoryNames => {
                    ...
                    $.ajax({
                        url: 'https://firestore.googleapis.com/v1/projects/e-commerce-base2/databases/(default)/documents/Purchase',
                        type: 'POST',
                        contentType: 'application/json',
